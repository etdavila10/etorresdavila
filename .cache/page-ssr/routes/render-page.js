...
var React = _interopRequireWildcard(__webpack_require__(6295));
...
var _react = __webpack_require__(6295);
...
var _react = _interopRequireDefault(__webpack_require__(6295));
...
exports.components={"component---src-pages-404-js":()=>__webpack_require__.e(/* import() | component---src-pages-404-js */ 883).then(__webpack_require__.bind(__webpack_require__, 429)),"component---src-pages-index-js":()=>__webpack_require__.e(/* import() | component---src-pages-index-js */ 678).then(__webpack_require__.bind(__webpack_require__, 663))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-google-fonts',plugin:__webpack_require__(7325),options:{"plugins":[],"fonts":["Jost:400,700","Pacifico"],"display":"swap"}},{name:'gatsby-plugin-manifest',plugin:__webpack_require__(5822),options:{"plugins":[],"name":"Eduardo Torres Davila","short_name":"Eduardo","start_url":"/","icon":"src/images/android-chrome-192x192.png","legacy":true,"theme_color_in_head":true,"cache_busting_mode":"query","crossOrigin":"anonymous","include_favicon":true,"cacheDigest":"419448a0f99fd94a5da88b2572005c45"}},{name:'partytown',plugin:__webpack_require__(5292),options:{"plugins":[]}}];/* global plugins */ // During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6295);
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "navigate": () => (/* reexport */ gatsby_link_navigate),
  ...
  "withAssetPrefix": () => (/* reexport */ withAssetPrefix),
  "withPrefix": () => (/* reexport */ withPrefix)
});
...
;// CONCATENATED MODULE: ./node_modules/gatsby-link/parse-path.js
...
;// CONCATENATED MODULE: ./node_modules/gatsby-link/is-local-link.js
...
;// CONCATENATED MODULE: ./node_modules/gatsby-link/rewrite-link-path.js
...
function absolutify(path, current) {
  ...
  const absolutePath = (0,utils/* resolve */.DB)(path, current);

  if (option === `always` || option === `never`) {
    return (0,apply_trailing_slash_option/* applyTrailingSlashOption */.H)(absolutePath, option);
  }
...
const rewriteLinkPath = (path, relativeTo) => {
  ...
  if (option === `always` || option === `never`) {
    const output = (0,apply_trailing_slash_option/* applyTrailingSlashOption */.H)(pathname, option);
...
;// CONCATENATED MODULE: ./node_modules/gatsby-link/index.js
...
const getGlobalPathPrefix = () =>  false ? 0 : "";

const getGlobalBasePrefix = () =>  false ? 0 : "";
...
const NavLinkPropTypes = {
  ...
  partiallyActive: (prop_types_default()).bool
...
function GatsbyLinkLocationWrapper(props) {
  return /*#__PURE__*/index_js_default().createElement(es.Location, null, ({
    location
  }) => /*#__PURE__*/index_js_default().createElement(GatsbyLink, extends_default()({}, props, {
    _location: location
  })));
}

class GatsbyLink extends (index_js_default()).Component {
  constructor(props) {
    ...
    this.defaultGetProps = ({
      ...
      if (this.props.partiallyActive ? isPartiallyCurrent : isCurrent) {
        return {
          ...
          style: extends_default()({}, this.props.style, this.props.activeStyle)
        };
      }
  ...
  render() {
    const _this$props = this.props,
      ...
      _location
          ...
          rest = objectWithoutPropertiesLoose_default()(_this$props, _excluded);
    ...
    if (!isLocalLink(prefixedTo)) {
      return /*#__PURE__*/index_js_default().createElement("a", extends_default()({
        href: prefixedTo
      }, rest));
    }

    return /*#__PURE__*/index_js_default().createElement(es.Link, extends_default()({
      to: prefixedTo,
      state: state,
      getProps: getProps,
...
GatsbyLink.propTypes = extends_default()({}, NavLinkPropTypes, {
  onClick: (prop_types_default()).func,
  to: (prop_types_default()).string.isRequired,
  replace: (prop_types_default()).bool,
  state: (prop_types_default()).object
});
/* harmony default export */ const gatsby_link = (/*#__PURE__*/index_js_default().forwardRef((props, ref) => /*#__PURE__*/index_js_default().createElement(GatsbyLinkLocationWrapper, extends_default()({
  innerRef: ref
}, props))));
const gatsby_link_navigate = (to, options) => {
...
"use strict";
var _interopRequireDefault=__webpack_require__(4836);var React=_interopRequireWildcard(__webpack_require__(6295));var _gatsby=__webpack_require__(7609);var _common=__webpack_require__(5428);var _getManifestPathname=_interopRequireDefault(__webpack_require__(292));function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: remove for v3
...
"use strict";
exports.__esModule=true;exports["default"]=void 0;var _gatsby=__webpack_require__(7609);/**
...
"use strict";
module.exports = require("/Users/etdavila/Documents/etdavila10.github.io/.cache/ssr-builtin-trackers/fs");
...
"use strict";
module.exports = require("/Users/etdavila/Documents/etdavila10.github.io/node_modules/react-dom/server.js");
...
"use strict";
module.exports = require("/Users/etdavila/Documents/etdavila10.github.io/node_modules/react/index.js");
...
var React = __webpack_require__(6295);
...
"use strict";
module.exports = JSON.parse('{"polyfill":["/polyfill-28dbfa58150ea9910781.js"],"app":["/app-b92afec905156a18e81e.js"],"component---src-pages-404-js":["/component---src-pages-404-js-76b1282710738288e100.js"],"component---src-pages-index-js":["/component---src-pages-index-js-103e9c058007c8013ab6.js"]}');
...
/* harmony export */ });
/* global HAS_REACT_18 */const React=__webpack_require__(6295);const path=__webpack_require__(1423);const{renderToString,renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(6114);const{ServerLocation,Router,isRedirect}=__webpack_require__(3631);const merge=__webpack_require__(9996);const{StaticQueryContext}=__webpack_require__(7609);const fs=__webpack_require__(8403);const{WritableAsPromise}=__webpack_require__(5897);const{RouteAnnouncerProps}=__webpack_require__(236);const{apiRunner,apiRunnerAsync}=__webpack_require__(4067);const asyncRequires=__webpack_require__(5418);const{version:gatsbyVersion}=__webpack_require__(1741);const{grabMatchParams}=__webpack_require__(9755);const chunkMapping=__webpack_require__(9804);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
